[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/i8Cmp59D)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=23902919)
...
The activity guide includes `import React from 'react'` and `React.FC` in the component code.
In newer versions of React (17+), you no longer need to explicitly import React for JSX to work.
Using the import caused a blank page in my setup. VS Code flagged it with a warning and suggested
removing it, which fixed the issue. I simplified the component to:
